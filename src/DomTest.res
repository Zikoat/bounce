...
let canvasEl: Dom.element = document->Webapi.Dom.Document.createElement("canvas")
...
let noRepeatPatern: pattern = ctx->createPattern(document->Webapi.Dom.Document.createElement("img"), #noRepeat)
let repeatPatern: pattern = ctx->createPattern(document->Webapi.Dom.Document.createElement("img"), #repeat)
let repeatXPatern: pattern = ctx->createPattern(document->Webapi.Dom.Document.createElement("img"), #repeatX)
let repeatYPatern: pattern = ctx->createPattern(document->Webapi.Dom.Document.createElement("img"), #repeatY)
...
let image: Webapi.Dom.HtmlImageElement.t = Webapi.Dom.HtmlImageElement.makeWithSize(16, 16)
...
let imageFromCoords: Webapi.Dom.Image.t = createImageDataCoords(ctx, ~width=0.0, ~height=0.0)
let imageFromData: Webapi.Dom.Image.t = createImageDataFromImage(ctx, imageFromCoords)
let w: float = Webapi.Dom.Image.width(imageFromCoords)
let h: float = Webapi.Dom.Image.height(imageFromCoords)

let frameFromImage: Webapi.Dom.Image.t = getImageData(ctx, ~sx=0.0, ~sy=0.0, ~sw=0.0, ~sh=0.0)
